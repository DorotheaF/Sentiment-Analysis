...
print("Train set accuracy: " + str(accuracy/37))

accuracy = 0
for review in matrix:
    accuracy += test_categorizer(review, weights)

print("Test set accuracy: " + str(accuracy/152))

#for additional reviews
reader = open("processed/reviews_aditional.csv", "r")
additional = []
for review in reader:
    review = review.replace('\n', "").split(',')
...
accuracy = 0
for review in additional:
    accuracy += test_categorizer(review, weights)

print("Additional set accuracy: " + str(accuracy/38932))
